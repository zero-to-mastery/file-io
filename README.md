...
**Note: The project must successfully complete one of the challenges below to qualify as a submission.**

### Challenges

1. Write a script to identify the number of songs in the file.
2. Write a script that identifies the number of songs in the key of E.
...
- The CSV file (spotify-2023.csv) containing the Spotify data that you want to analyze. Make sure to adjust the filename and path as needed.
