...
df = pd.read_csv('./file-io/spotify-2023.csv')
...
e_songs = df[df['key'] == 'E']  # Replace 'key' with the actual column name for key
...
print(value_counts)
print(f"The most common value in '{column_to_count}' is '{most_common_value}' with {value_counts.max()} occurrences.")